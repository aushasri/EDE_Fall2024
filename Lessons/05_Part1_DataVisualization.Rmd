...
PeterPaul.chem.nutrients <- 
  read.csv(here("Data/Processed/NTL_LTER_Lake_Chemistry_Nutrients_PeterPaul_Processed.csv"), stringsAsFactors = TRUE)
PeterPaul.chem.nutrients.gathered <-
  NTL_LTER_Lake_Nutrients_PeterPaulGathered_Processed
EPAair <- EPAair_O3_PM25_NC1819_Processed
