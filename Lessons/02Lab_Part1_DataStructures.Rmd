...
temps_F <- c(80, 82, 80, 75, 76) #Vector type: Numeric
...
matrix1[4, 1] # First number is rows, second number is columns

matrix1[4,  ] # Gives the entire 4th row

matrix1[ , 3] # Gives the entire 3rd column

matrix1[c(12, 14)] # 

matrix1[c(12:14)] #

matrix1[2:4, 1:3] # Make a smaller subset matrix from the initial matrix
...
```{r Creating Lists}
# Lists ---- 
# Creating Lists, when an object has multiple attributes
list1 <- list(
  name = "Maria", 
  mynumbers = vector1, 
  mymatrix = matrix1, 
...
# When you want to change the name of an object in a list, use [[]] double brackets
list1$name = "Janelle"
