...
#6 Save all four processed datasets in the Processed folder. Use the write.csv function.
...
O3_NC2018_Processed <- read.csv( "./Data/Processed/EPAair_O3_NC2018_Processed.csv")

O3_NC2019_Processed <- read.csv( "./Data/Processed/EPAair_O3_NC2019_Processed.csv")

PM25_NC2018_Processed <- read.csv( "./Data/Processed/EPAair_PM25_NC2018_Processed.csv")

PM25_NC2019_Processed <- read.csv( "./Data/Processed/EPAair_PM25_NC2019_Processed.csv")
...
O3_PM25_NC1819 <- rbind(O3_NC2018_Processed, O3_NC2019_Processed, PM25_NC2018_Processed, PM25_NC2019_Processed)

#8 Wrangle your new dataset with a pipe function (%>%) so that it includes only sites that the four data frames have in common.
...
O3_PM25_NC1819_Sites_Spread <-
  pivot_wider(O3_PM25_NC1819_Sites, names_from = AQS_PARAMETER_DESC, values_from = Mean.DAILY.AQI)
...
write.csv(O3_PM25_NC1819_Sites_Spread, row.names = FALSE, file = "./Data/Processed/EPAair_O3_PM25_NC1819_Processed.csv")
