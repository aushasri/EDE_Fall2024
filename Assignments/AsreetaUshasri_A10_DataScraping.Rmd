...
URL <-
  read_html('https://www.ncwater.org/WUDC/app/LWSP/report.php?
            pwsid=03-32-010&year=2023')
...
Water_Plot <- ggplot(Durham_Water_DF, aes(x = Month_Date, y = Max_Day_Use)) +
  geom_line() + labs(title = "Maximum Daily Water Use
  Durham County, NC (2023)",
                     x = "Month",
                     y = "Max Daily Usage (MDG)") + theme_light() +
...
plot_grid(Durham_Data, Asheville_Data)
...
#9 
dfs_2020 <- map2(the_years, the_facility_ids_subset, Water_Usage_DF_Function) 
