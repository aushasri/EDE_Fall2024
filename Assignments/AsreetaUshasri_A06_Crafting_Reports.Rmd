...
`EPAair_O3_PM25_NC1819_Processed.csv`, `2018-2019`, and  
...
#Import EPA data (from the processed folder) & fix dates
epa_data <- read.csv(
...
```{r data.summary, warning=FALSE, echo=FALSE}
...
kable(x = summary_PM25, digits = 2,
      col.names = c('County', "$\\mu g/m^3$"),
      caption = "Mean Particulates (2.5mm)")

kable(x = summary_Ozone, digits = 2,
      col.names = c('County', "$\\mu g/m^3$"),
      caption = "Mean Ozone")
...
```{r boxplot.2018, warning=FALSE, echo=FALSE,  fig.align='left', fig.cap = '2018 Monthly Ozone Levels', fig.height=2.85}

#Plot Ozone for 2018 from epa_data
#Use factor for Month to add the Month Abbreviation Labels
#Add titles using + labs() operation
...
Ozone2018Plot <-
  ...
  geom_boxplot() +
  labs(
    title = "Ozone Level Concentration by Month, 2018",
    x = "Month",
    y = "Ozone")
...
```{r boxplot.2019, warning=FALSE, echo=FALSE, fig.align='left', fig.cap = '2019 Monthly Ozone Levels', fig.height=2.85}

#Plot Ozone for 2019 from epa_data
#Use factor for Month to add the Month Abbreviation Labels
#Add titles using + labs() operation
...
Ozone2019Plot <-
  ...
  geom_boxplot() +
  labs(
    title = "Ozone Level Concentration by Month, 2019",
    x = "Month",
    y = "Ozone")
...
https://github.com/aushasri/EDE_Fall2024
