...
GaringerOzone_Raw_Columns <- select(GaringerOzone_Raw, "Date", "Daily.Max.8.hour.Ozone.Concentration", "DAILY_AQI_VALUE")
...
GaringerOzone_PPM <- ggplot(data = GaringerOzone,
  ...
  geom_line(colour = "darkgray") + labs(
    title = "Ozone Concentration (PPM) in Garinger, 2010-2019",
    x = "Date",
    y = "Ozone Concentration (PPM)") + 
  theme(axis.title.y =
             element_text(angle = 90)) + geom_smooth(method = "lm")
