...
mapview(NWIS, zcol = "GageHeight", cex = "GageHeight",
        legend = TRUE) +
  mapview(Counties, col.regions = "lightyellow")
...
mapview(LancasterCounty, col.regions = "pink",
        map.types = c("CartoDB.Positron")) +
  mapview(Lancaster_Gage_Height_15km, col.regions = "blue") +
